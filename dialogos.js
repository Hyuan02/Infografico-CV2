dialogo1 = {"indiceDialogo":0, "conteudo": [
    ...
    {"nome": "Jogador", "texto":"..."},
    {"nome": "Ann, a Estalajadeira", "texto":"Entendo... Então você não é deste reino não é? Certo ! Vou lhe explicar. Um Jogo é uma relíquia bastante preciosa nesse reino e através dela você consegue chegar no tesouro da Experiência. Cada Jogo tem seus próprios princípios que são utilizados para sua construção. Eles variam de acordo com cada um que os constroem, como por exemplo regras, objetivos, valor endógeno, imersão, interação entre outros. Com esses princípios, cada Jogo pode chegar na Experiência."},
    {"nome": "Ann, a Estalajadeira", "texto":"A Experiência é uma magia muito poderosa, capaz de mexer com as pessoas e é considerada o maior tesouro para todos os usuários de Jogos. Ela é capaz de nos proporcionar várias sensações e por isso é tão almejada nesse reino. Algumas Experiências podem nos proporcionar diversão, umas podem nos fazer fugir de nossa realidade e outras permitem que façamos o que desejarmos. São muitas as Experiências que podemos buscar."},
    {"nome": "Ann, a Estalajadeira", "texto":" Agora que você já sabe o que é um Jogo, deve construir um para conseguir sua Experiência. Você tem que planejar como quer que ele seja, essa etapa se chama Projeto. Com o Projeto feito e documentado, poderá construir seu Jogo através da Prototipação. Primeiro, vamos definir que tipo de Experiência você quer conseguir com seu Jogo. Existem jogos específicos para cada Experiência que se deseja conseguir, então escolha com sabedoria o que você deseja e eu lhe darei um mapa para ela!"},
    {"alternativas":[ {"valor":"Diversão", "selecionado":false}, {"valor":"Fuga", "selecionado":false}, {"valor":"Prazer", "selecionado":false}, {"valor":"Livre Escolha", "selecionado":false}], "imagens":["quest.png"]},
...
dialogo2 = {"indiceDialogo":0, "conteudo":[
    ...
    {"nome": "Jogador", "texto":"...."},
    {"nome": "Rudolph, o Mago", "texto":" A Mecânica é o Elemento do objetivo, das regras e possibilidades. É ela que define o Jogo em si. A Narrativa é o Elemento da história e dos eventos. Um jogo poderá conter ou não uma história. Caberá a você decidir se ela será relevante ou não. A Estética é o Elemento responsável pela aparência, sensações, sons, cheiros e sabores do Jogo. Sendo ela, o Elemento mais ligado à Experiência. Por fim, a Tecnologia é o Elemento dos materiais e interações que tornaram seu Jogo possível."},
    ...
    {"nome": "Jogador", "texto":"..."},
    {"alternativas":[{"valor":"Núcleo da Mecânica", "selecionado":false}, {"valor":"Núcleo da Narrativa", "selecionado":false}, {"valor":"Núcleo da Estética", "selecionado":false}, {"valor":"Núcleo da Tecnologia", "selecionado":false}], "imagens":["esfera1.png","esfera2.png"]},
...
dialogo8 = {"indiceDialogo":0, "conteudo":[
    ...
    {"alternativas":[{"valor":"Mecânica de Administração de Recursos", "selecionado":false },{"valor":"Mecânica de Memória", "selecionado":false },{"valor":"Mecânica de Coleta de Itens", "selecionado":false },{"valor":"Mecânica de Negociação", "selecionado":false}]},
    ...
    {"nome":"Ann, a Estalajadeira","texto":"O Balanceamento é extremamente importante para que o Jogo não se tornear desagradável. Tudo checado, agora finalmente você tem seu Jogo e já pode sair para buscar o grande tesouro da Experiência. Não esqueça de documentar antes de sair!"}
]};
...
dialogoGenerico6 = {"indiceDialogo":0, "conteudo":[
    {"nome": "Aprendiz", "texto":"Os Exploradores são um tipo de Jogador que gosta de todo o jogo ou seu mapa para descobrir novas coisas. Jogos que permitam a exploração de áreas irá agradar bastante esse perfil."},
], "aconteceu" : false};
dialogoGenerico7 = {"indiceDialogo":0, "conteudo":[
    {"nome": "Aprendiz", "texto":"Os Socializadores são um tipo de Jogador que gosta de se relacionar com outras pessoas. O companherismo é importante para esse tipo de Jogador. Jogos com o quesito de cooperatividade irá agradar bastante esse perfil."},
], "aconteceu" : false};
